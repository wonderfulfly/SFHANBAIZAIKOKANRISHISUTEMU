 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A009InsertSaveEntity
 * @version

 */
public class A009InsertSaveEntity {
   /**
	*	 KYAKUSAKIID 客先ID
	*/
	...
	*/
	public void setNYUUKINKINGAKU(String NYUUKINKINGAKU) {
	...
	*/
	public String getNYUUKINKINGAKU() {
