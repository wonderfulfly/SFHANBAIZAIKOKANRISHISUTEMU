 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A009Insert61GridSaveEntity
 * @version

 */
public class A009Insert61GridSaveEntity {
   /**
   ...
   /**
	* RESHIITOMEISAINO レシート明細NOを設定
	*
	* @param RESHIITOMEISAINO レシート明細NO
	*/
   ...
   /**
	* RESHIITOMEISAINO レシート明細NOを取得
	*
	* @return RESHIITOMEISAINO レシート明細NO
	*/
