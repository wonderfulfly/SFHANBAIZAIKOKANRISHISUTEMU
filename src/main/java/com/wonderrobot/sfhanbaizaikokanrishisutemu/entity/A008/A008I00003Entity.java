 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A008I00003Entity
 * @version

 */
public class A008I00003Entity {
   /**
	*	 CHUUBUNSHONO 注文書NO
	*/
   ...
   /**
	* FURIDASHIZUMIHIDZUKE 振出済み日付を設定
	*
	* @param FURIDASHIZUMIHIDZUKE 振出済み日付
	*/
   ...
   /**
	* FURIDASHIZUMIHIDZUKE 振出済み日付を取得
	*
	* @return FURIDASHIZUMIHIDZUKE 振出済み日付
	*/
   ...
   /**
	* NYUUKINWARIAI 入金割合を設定
	*
	* @param NYUUKINWARIAI 入金割合
	*/
   ...
   /**
	* NYUUKINWARIAI 入金割合を取得
	*
	* @return NYUUKINWARIAI 入金割合
	*/
   ...
   /**
	* MINYUUKINWARIAI 未入金割合を設定
	*
	* @param MINYUUKINWARIAI 未入金割合
	*/
   ...
   /**
	* MINYUUKINWARIAI 未入金割合を取得
	*
	* @return MINYUUKINWARIAI 未入金割合
	*/
	...
	*/
	public void setSHUUSHOVIEW_MINYUUKINKINGAKU14(double SHUUSHOVIEW_MINYUUKINKINGAKU14) {
	...
	*/
	public double getSHUUSHOVIEW_MINYUUKINKINGAKU14() {
