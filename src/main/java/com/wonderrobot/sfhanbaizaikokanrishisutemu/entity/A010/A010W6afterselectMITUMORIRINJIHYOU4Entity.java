 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A010W6afterselectMITUMORIRINJIHYOU4Entity
 * @version

 */
public class A010W6afterselectMITUMORIRINJIHYOU4Entity {
   /**
	*	 MITSUMORINO 見積りNO
	*/
	...
	* SAKUSEISHA 作成者を取得
	*
	* @return SAKUSEISHA 作成者
	*/
	public String getSAKUSEISHA() {
		return this.SAKUSEISHA;
	}
	...
	* @param WARIBIKI 割引
	*/
	public void setWARIBIKI(double WARIBIKI) {
