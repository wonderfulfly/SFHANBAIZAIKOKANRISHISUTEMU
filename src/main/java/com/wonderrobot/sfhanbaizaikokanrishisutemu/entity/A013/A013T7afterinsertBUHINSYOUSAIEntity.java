 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A013T7afterinsertBUHINSYOUSAIEntity
 * @version

 */
public class A013T7afterinsertBUHINSYOUSAIEntity {
   /**
   ...
   /**
	*	 ZAISHITSU_KEISHIKI 材質_形式
	*/
	private String ZAISHITSU_KEISHIKI;
   /**
	*	 SEISAKUSHA 製作者
	*/
   ...
   /**
	* ZAISHITSU_KEISHIKI 材質_形式を設定
	*
	* @param ZAISHITSU_KEISHIKI 材質_形式
	*/
	public void setZAISHITSU_KEISHIKI(String ZAISHITSU_KEISHIKI) {
		this.ZAISHITSU_KEISHIKI = ZAISHITSU_KEISHIKI;
	}

   /**
	* ZAISHITSU_KEISHIKI 材質_形式を取得
	*
	* @return ZAISHITSU_KEISHIKI 材質_形式
	*/
	public String getZAISHITSU_KEISHIKI() {
		return this.ZAISHITSU_KEISHIKI;
	}
