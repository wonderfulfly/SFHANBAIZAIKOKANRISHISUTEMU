 ...
 *     SF販売在庫管理システム
 * @comment
 *     table id: A013T7afterselectBUHINSYOUSAIRINJIHYOU2Entity
 * @version

 */
public class A013T7afterselectBUHINSYOUSAIRINJIHYOU2Entity {
   /**
	*	 HINMEI 品名
	*/
	...
	* SEISAKUSHA 製作者を設定
	*
	* @param SEISAKUSHA 製作者
	*/
	public void setSEISAKUSHA(String SEISAKUSHA) {
		this.SEISAKUSHA = SEISAKUSHA;
	}

   /**
	* SEISAKUSHA 製作者を取得
	*
	* @return SEISAKUSHA 製作者
	*/
	public String getSEISAKUSHA() {
		return this.SEISAKUSHA;
	}
   ...
   /**
	* KOUNYUUHIDZUKE 購入日付を設定
	*
	* @param KOUNYUUHIDZUKE 購入日付
	*/
	public void setKOUNYUUHIDZUKE(String KOUNYUUHIDZUKE) {
		this.KOUNYUUHIDZUKE = KOUNYUUHIDZUKE;
	}

   /**
	* KOUNYUUHIDZUKE 購入日付を取得
	*
	* @return KOUNYUUHIDZUKE 購入日付
	*/
	public String getKOUNYUUHIDZUKE() {
		return this.KOUNYUUHIDZUKE;
	}
