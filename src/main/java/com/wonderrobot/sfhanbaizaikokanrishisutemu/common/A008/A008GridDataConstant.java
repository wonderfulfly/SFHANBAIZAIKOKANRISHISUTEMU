...
public class A008GridDataConstant {
	...
	static {
		...
		sBuffer.append("<td class='g1 o' _colid=14 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='USHUUSHOVIEW_MINYUUKINWARIAI13_9999999'  name='USHUUSHOVIEW_MINYUUKINWARIAI13_9999999'  value='WFC#COLUMN_VALUE#WFC51WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:72px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='51'  _itemname='未入金%'  _rge='1' onblur='changeSpecHtml(this);' type='text'  _gid='Grid23'  _gflg='Grid23flg9999999' ></div></td>");
		sBuffer.append("<td class='g3 o' _colid=15 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHUUSHOVIEW_MINYUUKINKINGAKU14_9999999'  name='SHUUSHOVIEW_MINYUUKINKINGAKU14_9999999'  value='WFC#COLUMN_VALUE#WFC53WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:82px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='53'  _itemname='未入金金額'  _ire='###,###,##0'  _rge='1' onblur='changeSpecHtml(this);' type='text'  _gid='Grid23'  _gflg='Grid23flg9999999' ></div></td>");
		...
		sBuffer.append("<td class='g1 o' _colid=14 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='USHUUSHOVIEW_MINYUUKINWARIAI13_0'  name='USHUUSHOVIEW_MINYUUKINWARIAI13_0'  class='readonly' readOnly style='width:72px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='51'  _itemname='未入金%'  _rge='1' onblur='changeSpecHtml(this);' type='text'  _gid='Grid23'  _gflg='Grid23flg0' ></div></td>");
		sBuffer.append("<td class='g3 o' _colid=15 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHUUSHOVIEW_MINYUUKINKINGAKU14_0'  name='SHUUSHOVIEW_MINYUUKINKINGAKU14_0'  class='readonly' readOnly style='width:82px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='53'  _itemname='未入金金額'  _ire='###,###,##0'  _rge='1' onblur='changeSpecHtml(this);' type='text'  _gid='Grid23'  _gflg='Grid23flg0' ></div></td>");
		...
		itemBean.SubID = "51";
		itemBean.TableID = "I00003";
		itemBean.FieldID = "USHUUSHOVIEW_MINYUUKINWARIAI13";
		itemBean.ReadOnly = "1";
		itemBean.RelData = "";
		itemBean.DefaultValue = "";
		itemBean.DbFlg = "0";
		...
		itemBean.SubID = "53";
		itemBean.TableID = "I00003";
		itemBean.FieldID = "SHUUSHOVIEW_MINYUUKINKINGAKU14";
		itemBean.ReadOnly = "1";
		itemBean.RelData = "";
		itemBean.DefaultValue = "";
		itemBean.DbFlg = "0";
