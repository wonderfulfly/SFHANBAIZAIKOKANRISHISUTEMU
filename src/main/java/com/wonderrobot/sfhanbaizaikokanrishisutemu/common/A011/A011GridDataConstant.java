...
public class A011GridDataConstant {
	...
	static {
		...
		sBuffer.append("<td class='g3 o' _colid=3 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SUURYOU_9999999'  name='SUURYOU_9999999'  value='WFC#COLUMN_VALUE#WFC101WFC#COLUMN_VALUE#WFC'  class='editable' style='width:89px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='101'  _itemname='数量'  type='text'  onChange ='getObj(\"SUURYOU_9999999\").value=this.value;F20220915174801892($(this));F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  _gid='Grid95'  _gflg='Grid95flg9999999' ></div></td>");
		sBuffer.append("<td class='g3 o' _colid=4 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='HANBAITANKA_9999999'  name='HANBAITANKA_9999999'  value='WFC#COLUMN_VALUE#WFC103WFC#COLUMN_VALUE#WFC'  class='editable' style='width:73px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='103'  _itemname='販売単価'  _ire='###,###,##0'  _rge='1'  type='text'  onChange ='getObj(\"HANBAITANKA_9999999\").value=this.value;F20220915174801892($(this));F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  _gid='Grid95'  _gflg='Grid95flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><select id=KAHEI_9999999 name=KAHEI_9999999 data-bind='value: KAHEI' _req=0 class='editable' _subid=105 _itemname='貨幣' _gid='Grid95' _gflg='Grid95flg9999999' onChange ='getObj(\"KAHEI_9999999\").value=this.value;F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  style='width:54px;height:27px;font-size:14px;color:#000000;font-weight:normal;'>WFC#ROW_DROPDOWNLIST_OPTIONS#WFC105WFC#ROW_DROPDOWNLIST_OPTIONS#WFC</select></div></td>");
		sBuffer.append("<td class='g3 o' _colid=6 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='HANBAIKINGAKU_9999999'  name='HANBAIKINGAKU_9999999'  value='WFC#COLUMN_VALUE#WFC107WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:66px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='107'  _itemname='販売金額'  _ire='###,###,##0'  _rge='1'  type='text'  onChange ='getObj(\"HANBAIKINGAKU_9999999\").value=this.value;F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  _gid='Grid95'  _gflg='Grid95flg9999999' ></div></td>");
		...
		sBuffer.append("<td class='g3 o' _colid=3 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SUURYOU_0'  name='SUURYOU_0'  class='editable' style='width:89px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='101'  _itemname='数量'  _rge='1'  type='text'  onChange ='getObj(\"SUURYOU_0\").value=this.value;F20220915174801892($(this));F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  _gid='Grid95'  _gflg='Grid95flg0' ></div></td>");
		...
		sBuffer.append("<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><select id=KAHEI_0 name=KAHEI_0 data-bind='value: KAHEI' _req=0 class='editable' _subid=105 _itemname='貨幣' _gid='Grid95' _gflg='Grid95flg0' onChange ='getObj(\"KAHEI_0\").value=this.value;F20220915174801910($(this));F20220915174801928($(this));F20220915174801947($(this));cs($(this),\"rowseq\",\"Grid95flg\",\"0\");'  style='width:54px;height:27px;font-size:14px;color:#000000;font-weight:normal;'>WFC#ROW_DROPDOWNLIST_OPTIONS#WFC105WFC#ROW_DROPDOWNLIST_OPTIONS#WFC</select></div></td>");
