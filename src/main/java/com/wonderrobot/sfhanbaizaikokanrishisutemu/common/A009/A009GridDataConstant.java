...
public class A009GridDataConstant {
	...
	static {
		...
		sBuffer.append("<td class='g3 o' _colid=4 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='FURIDASHIZUMIKINGAKU_9999999'  name='FURIDASHIZUMIKINGAKU_9999999'  value='WFC#COLUMN_VALUE#WFC69WFC#COLUMN_VALUE#WFC'  class='editable' style='width:147px;height:31px; padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='69'  _itemname='振出済み金額'  _ire='###,###,##0.##'  _rge='1'  type='text'  onChange ='getObj(\"FURIDASHIZUMIKINGAKU_9999999\").value=this.value;A009FURIDASHIZUMIWARIAICount($(this));cs($(this),\"rowseq\",\"Grid61flg\",\"0\");'  _gid='Grid61'  _gflg='Grid61flg9999999' ></div></td>");
		...
		sBuffer.append("<td class='g3 o' _colid=7 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='NYUUKINZUMIKINGAKU_9999999'  name='NYUUKINZUMIKINGAKU_9999999'  value='WFC#COLUMN_VALUE#WFC75WFC#COLUMN_VALUE#WFC'  class='editable' style='width:90px;height:31px; padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='75'  _itemname='入金済み金額'  _ire='###,###,##0.##'  _rge='1'  type='text'  onChange ='getObj(\"NYUUKINZUMIKINGAKU_9999999\").value=this.value;A009NYUUKINZUMIWARIAICount($(this));cs($(this),\"rowseq\",\"Grid61flg\",\"0\");'  _gid='Grid61'  _gflg='Grid61flg9999999' ></div></td>");
		...
		map.put("61", sBuffer.toString());
		GridRowStartTDMap.put("A009", map);
		...
		sBuffer.append("<td class='g1 o' _colid=2 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHIHARAIWARIAI_0'  name='SHIHARAIWARIAI_0'  class='editable' style='width:150px;height:31px; padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;'  _subid='65'  _itemname='支払割合'  _rge='2'  type='text'  onChange ='getObj(\"SHIHARAIWARIAI_0\").value=this.value;A009NYUUKINZUMIWARIAICount($(this));cs($(this),\"rowseq\",\"Grid61flg\",\"0\");'  _gid='Grid61'  _gflg='Grid61flg0' ></div></td>");
		...
		sBuffer.append("<td class='g3 o' _colid=4 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='FURIDASHIZUMIKINGAKU_0'  name='FURIDASHIZUMIKINGAKU_0'  class='editable' style='width:147px;height:31px; padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='69'  _itemname='振出済み金額'  _ire='###,###,##0.##'  _rge='1'  type='text'  onChange ='getObj(\"FURIDASHIZUMIKINGAKU_0\").value=this.value;A009FURIDASHIZUMIWARIAICount($(this));cs($(this),\"rowseq\",\"Grid61flg\",\"0\");'  _gid='Grid61'  _gflg='Grid61flg0' ></div></td>");
		...
		sBuffer.append("<td class='g3 o' _colid=7 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='NYUUKINZUMIKINGAKU_0'  name='NYUUKINZUMIKINGAKU_0'  class='editable' style='width:90px;height:31px; padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='75'  _itemname='入金済み金額'  _ire='###,###,##0.##'  _rge='1'  type='text'  onChange ='getObj(\"NYUUKINZUMIKINGAKU_0\").value=this.value;A009NYUUKINZUMIWARIAICount($(this));cs($(this),\"rowseq\",\"Grid61flg\",\"0\");'  _gid='Grid61'  _gflg='Grid61flg0' ></div></td>");
		...
		GridItemSubIDMap.put("A009", mapList);
	}
