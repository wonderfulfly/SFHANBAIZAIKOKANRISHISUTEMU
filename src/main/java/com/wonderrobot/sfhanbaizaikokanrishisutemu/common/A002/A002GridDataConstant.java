...
public class A002GridDataConstant {
	...
	static {
		...
		map.put("13", sBuffer.toString());
		GridRowStartTDMap.put("A002", map);
		...
		GridItemSubIDMap.put("A002", mapList);
	}
