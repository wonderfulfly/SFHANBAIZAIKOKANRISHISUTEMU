 ...
 *     null
 * @comment
 *      class: A002GridDataConstant
 *      Page: 
 * @version
 */

public class A002GridDataConstant {
	...
	static {
		...
		sBuffer.setLength(0);
		sBuffer.append("<td class='g1 o' _colid=1 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHAINID1_9999999'  name='SHAINID1_9999999'  value='WFC#COLUMN_VALUE#WFC15WFC#COLUMN_VALUE#WFC'  _k='1'  class='readonly' readOnly style='width:84px;height:25px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='15'  _itemname='社員ID' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=2 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHAINMEI1_9999999'  name='SHAINMEI1_9999999'  value='WFC#COLUMN_VALUE#WFC17WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:115px;height:31px; text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='17'  _itemname='社員名' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=3 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='DENWABANGOU_9999999'  name='DENWABANGOU_9999999'  value='WFC#COLUMN_VALUE#WFC19WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:111px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='19'  _itemname='電話番号' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=4 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='KEITAIBANGOU_9999999'  name='KEITAIBANGOU_9999999'  value='WFC#COLUMN_VALUE#WFC21WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:124px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='21'  _itemname='携帯番号' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='EMAIL_9999999'  name='EMAIL_9999999'  value='WFC#COLUMN_VALUE#WFC23WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:124px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='23'  _itemname='EMAIL' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=6 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='LINE_9999999'  name='LINE_9999999'  value='WFC#COLUMN_VALUE#WFC25WFC#COLUMN_VALUE#WFC'  class='readonly' readOnly style='width:112px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='25'  _itemname='LINE' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg9999999' ></div></td>");
		sBuffer.append("<td class='g1 l' _colid=7 style='word-wrap: break-word;'><input type=text name=showYUUZAAKENGEN_9999999 id=showYUUZAAKENGEN_9999999 value='WFC#ITEM_SHOW_VALUE#WFC27WFC#ITEM_SHOW_VALUE#WFC' class='readonly' readOnly _subid=27 _itemname='部門' style='width:95px;height:27px;font-size:14px;color:#000000;font-weight:normal;'><input type=hidden name=YUUZAAKENGEN_9999999 id=YUUZAAKENGEN_9999999 value='WFC#COLUMN_VALUE#WFC27WFC#COLUMN_VALUE#WFC'></td>");
		...
		sBuffer.append("<td style ='display:none' width='0px' _colid=9><input id='ROGUINID_9999999'  name='ROGUINID_9999999'  value='WFC#COLUMN_VALUE#WFC31WFC#COLUMN_VALUE#WFC'  _k='1'  type='hidden' ></div></td>");
		map.put("13", sBuffer.toString());
		GridDataRowTDMap.put("P00002", map);
		...
		map.put("13", sBuffer.toString());
		GridRowStartTDMap.put("P00002", map);

		//Grid title data map
		map = new HashMap<String, String>();
		sBuffer.setLength(0);
		sBuffer.append("<input type='hidden' name='initRowGrid13' id='initRowGrid13' value='9999999'><input type='hidden' name='RowGrid13' id='RowGrid13' value='9999999'><table id='Grid13' name ='Grid13' ><thead><tr><th style='text-align:center;'>No.</th><th style='overflow:hidden;text-align:center;'>社員ID</th><th style='overflow:hidden;text-align:center;'>社員名</th><th style='overflow:hidden;text-align:center;'>電話番号</th><th style='overflow:hidden;text-align:center;'>携帯番号</th><th style='overflow:hidden;text-align:center;'>EMAIL</th><th style='overflow:hidden;text-align:center;'>LINE</th><th style='overflow:hidden;text-align:center;'>部門</th><th style='overflow:hidden;text-align:center;'>編集</th><th style='display:none'>ログインID</th></tr></thead>");
		map.put("13", sBuffer.toString());
		GridTitleItemMap.put("P00002", map);
		...
		sBuffer.append("<td class='g1 o' _colid=1 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHAINID1_0'  name='SHAINID1_0'  value='[自動採番]'  _k='1'  class='readonly' readOnly style='width:84px;height:25px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='15'  _itemname='社員ID' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=2 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='SHAINMEI1_0'  name='SHAINMEI1_0'  class='readonly' readOnly style='width:115px;height:31px; text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='17'  _itemname='社員名' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=3 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='DENWABANGOU_0'  name='DENWABANGOU_0'  class='readonly' readOnly style='width:111px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='19'  _itemname='電話番号' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=4 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='KEITAIBANGOU_0'  name='KEITAIBANGOU_0'  class='readonly' readOnly style='width:124px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='21'  _itemname='携帯番号' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='EMAIL_0'  name='EMAIL_0'  class='readonly' readOnly style='width:124px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='23'  _itemname='EMAIL' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 o' _colid=6 style ='vertical-align:middle;'><div style=\"overflow:hidden;\"><input id='LINE_0'  name='LINE_0'  class='readonly' readOnly style='width:112px;height:31px; text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='25'  _itemname='LINE' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>");
		sBuffer.append("<td class='g1 l' _colid=7 style='word-wrap: break-word;'><input type=text name=showYUUZAAKENGEN_0 id=showYUUZAAKENGEN_0 value='WFC#ITEM_SHOW_VALUE#WFC27WFC#ITEM_SHOW_VALUE#WFC' class='readonly' readOnly _subid=27 _itemname='部門' style='width:95px;height:27px;font-size:14px;color:#000000;font-weight:normal;'><input type=hidden name=YUUZAAKENGEN_0 id=YUUZAAKENGEN_0 value='WFC#COLUMN_VALUE#WFC27WFC#COLUMN_VALUE#WFC'></td>");
		sBuffer.append("<td class='g1 o' _colid=8><div style=\"overflow:hidden;\"><input id='grdB6W6_0'  name='grdB6W6_0'  value='編集'   _subid='29'  _itemname='編集'  type='button'  _gid='Grid13'  _gflg='Grid13flg0'  onclick='doLinkTrans29($(this));'  _sf_class='button_red'></div></td>");
		sBuffer.append("<td style ='display:none' width='0px' _colid=9><input id='ROGUINID_0'  name='ROGUINID_0'  _k='1'  type='hidden' ></div></td></tr>");
		map.put("13", sBuffer.toString());
		GridRowZeroMap.put("P00002", map);

		//Grid item map
		mapList = new HashMap<String, ArrayList<ItemBean>>();
		beanList = new ArrayList<ItemBean>();
		itemBean = new A002GridDataConstant().new ItemBean();
		itemBean.OjeKind = "7";
		itemBean.SubID = "15";
		itemBean.TableID = "SYAIN";
		itemBean.FieldID = "SHAINID";
		itemBean.ReadOnly = "0";
		itemBean.RelData = "";
		...
		itemBean.SubID = "27";
		itemBean.TableID = "SYAIN";
		itemBean.FieldID = "YUUZAAKENGEN";
		itemBean.ReadOnly = "2";
		itemBean.RelData = "BUMON";
		itemBean.DefaultValue = "";
		itemBean.DbFlg = "0";
		beanList.add(itemBean);
		itemBean = new A002GridDataConstant().new ItemBean();
		...
		GridItemSubIDMap.put("P00002", mapList);
	}
	...
	*/
	public static String getGridStrSet (ArrayList<LinkedHashMap<String, String>> dataListMap, String pageID, String subID
		...
		int initRowNum = 0;
		if (isHaveGridTitle) {
			gridTitle = getMapValueByKey(pageID, subID, A002GridDataConstant.GridTitleItemMap);
		}
		
		gridRowZero = getMapValueByKey(pageID, subID, A002GridDataConstant.GridRowZeroMap);
		gridRowZero = changeGridItem(gridRowZero, pageID, subID, null)	;
		if (dataListMap != null && dataListMap.size() > 0) {
			rowStartTD = getMapValueByKey(pageID, subID, A002GridDataConstant.GridRowStartTDMap);
			
			rowTD = getMapValueByKey(pageID, subID, A002GridDataConstant.GridDataRowTDMap);
    ...
    A002DropDownListOptionBean ddloc = new A002DropDownListOptionBean();
