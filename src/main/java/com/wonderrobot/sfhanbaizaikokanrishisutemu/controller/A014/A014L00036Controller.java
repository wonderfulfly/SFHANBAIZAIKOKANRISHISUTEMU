 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A014L00036Controller
 *      Page: 
 * @version
 */

@Controller
public class A014L00036Controller {

	/**
	 * link name:部門検索_部門 , link id:L00036
	 * from:P00004部門検索 , to:P00003部門
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00036.do")
	public String L00036(HttpServletRequest request, HttpServletResponse response) {
