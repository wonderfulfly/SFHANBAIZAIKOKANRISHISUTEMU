...
import com.wonderrobot.sfhanbaizaikokanrishisutemu.service.A006.A006L4PrintService;
...
@Controller
public class A006L4PrintController {
	@Autowired
	private A006L4PrintService A006L4PrintService;
	@Autowired
	...
	* @throws Exception
	*/
	@RequestMapping("A006L4Print.do")
	public void A006L4Print (HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			A006L4PrintService.A006L4Print(request, jsonObj);
	...
	* @throws Exception
	*/
	@RequestMapping("A006L4PrintFile.do")
	public void A006L4PrintFile (HttpServletRequest request, HttpServletResponse response) throws Exception {
