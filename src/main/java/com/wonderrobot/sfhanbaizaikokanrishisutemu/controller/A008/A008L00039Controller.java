 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A008L00039Controller
 *      Page: 
 * @version
 */

@Controller
public class A008L00039Controller {

	/**
	 * link name:入金管理検索_入金管理詳細 , link id:L00039
	 * from:P00010入金管理検索 , to:P00011入金管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00039.do")
	public String L00039(HttpServletRequest request, HttpServletResponse response) {
