 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A010L00043Controller
 *      Page: 
 * @version
 */

@Controller
public class A010L00043Controller {

	/**
	 * link name:注文管理検索_注文管理詳細 , link id:L00043
	 * from:P00012注文管理検索 , to:P00013注文管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00043.do")
	public String L00043(HttpServletRequest request, HttpServletResponse response) {
