 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A010L00021Controller
 *      Page: 
 * @version
 */

@Controller
public class A010L00021Controller {

	/**
	 * link name:注文管理検索_注文管理詳細 , link id:L00021
	 * from:P00010注文管理検索 , to:P00011注文管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00021.do")
	public String L00021(HttpServletRequest request, HttpServletResponse response) {
