 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A015L00038Controller
 *      Page: 
 * @version
 */

@Controller
public class A015L00038Controller {

	/**
	 * link name:会社検索_会社 , link id:L00038
	 * from:P00006会社検索 , to:P00005会社
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00038.do")
	public String L00038(HttpServletRequest request, HttpServletResponse response) {
