 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011L00031Controller
 *      Page: 
 * @version
 */

@Controller
public class A011L00031Controller {

	/**
	 * link name:注文管理詳細_入金管理詳細 , link id:L00031
	 * from:P00013注文管理詳細 , to:P00011入金管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00031.do")
	public String L00031(HttpServletRequest request, HttpServletResponse response) {
