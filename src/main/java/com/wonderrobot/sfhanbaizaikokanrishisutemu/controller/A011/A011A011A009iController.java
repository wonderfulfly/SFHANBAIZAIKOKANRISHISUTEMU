 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011A011A009iController
 *      Page: 
 * @version
 */

@Controller
public class A011A011A009iController {

	/**
	 * link name:注文管理詳細_入金管理詳細 , link id:A011A009i
	 * from:P00013注文管理詳細 , to:P00011入金管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("A011A009i.do")
	public String A011A009i(HttpServletRequest request, HttpServletResponse response) {
