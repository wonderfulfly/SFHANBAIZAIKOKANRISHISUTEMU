...
import com.wonderrobot.sfhanbaizaikokanrishisutemu.service.A011.A011O6PrintService;
...
@Controller
public class A011O6PrintController {
	@Autowired
	private A011O6PrintService A011O6PrintService;
	@Autowired
	...
	* @throws Exception
	*/
	@RequestMapping("A011O6Print.do")
	public void A011O6Print (HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			A011O6PrintService.A011O6Print(request, jsonObj);
	...
	* @throws Exception
	*/
	@RequestMapping("A011O6PrintFile.do")
	public void A011O6PrintFile (HttpServletRequest request, HttpServletResponse response) throws Exception {
