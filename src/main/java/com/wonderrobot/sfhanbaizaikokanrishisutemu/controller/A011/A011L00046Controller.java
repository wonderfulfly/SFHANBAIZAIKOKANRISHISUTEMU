 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011L00046Controller
 *      Page: 
 * @version
 */

@Controller
public class A011L00046Controller {

	/**
	 * link name:注文管理詳細_部品管理画面 , link id:L00046
	 * from:P00013注文管理詳細 , to:P00014部品管理画面
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00046.do")
	public String L00046(HttpServletRequest request, HttpServletResponse response) {
