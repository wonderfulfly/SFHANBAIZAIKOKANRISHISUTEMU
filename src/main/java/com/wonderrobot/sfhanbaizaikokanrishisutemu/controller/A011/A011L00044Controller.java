 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011L00044Controller
 *      Page: 
 * @version
 */

@Controller
public class A011L00044Controller {

	/**
	 * link name:注文管理詳細_入金管理詳細 , link id:L00044
	 * from:P00013注文管理詳細 , to:P00011入金管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00044.do")
	public String L00044(HttpServletRequest request, HttpServletResponse response) {
