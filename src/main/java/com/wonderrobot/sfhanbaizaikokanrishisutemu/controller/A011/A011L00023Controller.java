 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011L00023Controller
 *      Page: 
 * @version
 */

@Controller
public class A011L00023Controller {

	/**
	 * link name:注文管理詳細_入金管理詳細 , link id:L00023
	 * from:P00011注文管理詳細 , to:P00009入金管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00023.do")
	public String L00023(HttpServletRequest request, HttpServletResponse response) {
