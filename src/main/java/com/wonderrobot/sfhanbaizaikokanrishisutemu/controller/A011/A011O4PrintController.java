...
import com.wonderrobot.sfhanbaizaikokanrishisutemu.service.A011.A011O4PrintService;
...
@Controller
public class A011O4PrintController {
	@Autowired
	private A011O4PrintService A011O4PrintService;
	@Autowired
	...
	* @throws Exception
	*/
	@RequestMapping("A011O4Print.do")
	public void A011O4Print (HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			A011O4PrintService.A011O4Print(request, jsonObj);
	...
	* @throws Exception
	*/
	@RequestMapping("A011O4PrintFile.do")
	public void A011O4PrintFile (HttpServletRequest request, HttpServletResponse response) throws Exception {
