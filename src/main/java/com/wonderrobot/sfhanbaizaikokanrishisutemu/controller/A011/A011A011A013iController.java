 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A011A011A013iController
 *      Page: 
 * @version
 */

@Controller
public class A011A011A013iController {

	/**
	 * link name:注文管理詳細_部品管理画面 , link id:A011A013i
	 * from:P00013注文管理詳細 , to:P00014部品管理画面
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("A011A013i.do")
	public String A011A013i(HttpServletRequest request, HttpServletResponse response) {
