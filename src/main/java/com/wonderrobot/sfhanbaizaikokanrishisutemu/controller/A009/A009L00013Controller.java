 ...
 *     SF販売在庫管理システム
 * @comment
 *      class: A009L00013Controller
 *      Page: 
 * @version
 */

@Controller
public class A009L00013Controller {

	/**
	 * link name:入金管理詳細_注文管理詳細 , link id:L00013
	 * from:P00011入金管理詳細 , to:P00013注文管理詳細
	 * 
	 * @return url to
	 * 
	 */
	@RequestMapping("L00013.do")
	public String L00013(HttpServletRequest request, HttpServletResponse response) {
