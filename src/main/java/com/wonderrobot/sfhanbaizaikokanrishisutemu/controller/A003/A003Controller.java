...
public class A003Controller {
	...
	* @throws Exception
	*/
	@RequestMapping("A003Init.do")
	public void A003Init (HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			LogFourJUtil.putMDC("部門", request);
