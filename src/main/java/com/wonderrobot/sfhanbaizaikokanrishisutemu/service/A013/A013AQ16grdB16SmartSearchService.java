...
public class A013AQ16grdB16SmartSearchService {
	...
	public void A013AQ16grdB16SmartSearch (HttpServletRequest request, JSONWFCObject jsonObj) throws Exception {
		...
		returnVal = A013GridDataConstant.getGridStrSet(A013AQ16grdB16SmartSearchEntityAy, "A013", "99", 50, 1);
		...
		A013GridDataConstant.setGridDataToSession("A013", "99", A013AQ16grdB16SmartSearchEntityAy, request);
