...
public class A013AQ16grdB16SmartSearchService {
	...
	public void A013AQ16grdB16SmartSearch (HttpServletRequest request, JSONWFCObject jsonObj) throws Exception {
		...
		returnVal = A013GridDataConstant.getGridStrSet(A013AQ16grdB16SmartSearchEntityAy, "P00014", "99", 50, 1);
		...
		A013GridDataConstant.setGridDataToSession("P00014", "99", A013AQ16grdB16SmartSearchEntityAy, request);
