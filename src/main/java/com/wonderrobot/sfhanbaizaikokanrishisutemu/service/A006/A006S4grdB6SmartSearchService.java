...
public class A006S4grdB6SmartSearchService {
	...
	public void A006S4grdB6SmartSearch (HttpServletRequest request, JSONWFCObject jsonObj) throws Exception {
		...
		returnVal = A006GridDataConstant.getGridStrSet(A006S4grdB6SmartSearchEntityAy, "A006", "19", 20, 1);
		...
		A006GridDataConstant.setGridDataToSession("A006", "19", A006S4grdB6SmartSearchEntityAy, request);
