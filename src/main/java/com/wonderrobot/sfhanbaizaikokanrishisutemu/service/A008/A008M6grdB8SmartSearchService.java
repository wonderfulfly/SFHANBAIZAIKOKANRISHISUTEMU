	...
	public void A008M6grdB8SmartSearch (HttpServletRequest request, JSONWFCObject jsonObj) throws Exception {
		...
		if (A008M6grdB8SmartSearchEntityList != null && A008M6grdB8SmartSearchEntityList.size() > 0) {
			for (int i = 0;i < A008M6grdB8SmartSearchEntityList.size();i++) {
				...
				selMap.put("I00003_MINYUUKINKINGAKU", StringUtil.changeNullToBlank(A008M6grdB8SmartSearchEntity_i.getA1MINYUUKINKINGAKU()));
		...
		returnVal = A008GridDataConstant.getGridStrSet(A008M6grdB8SmartSearchEntityAy, "P00010", "23", 20, 1);
		...
		A008GridDataConstant.setGridDataToSession("P00010", "23", A008M6grdB8SmartSearchEntityAy, request);
