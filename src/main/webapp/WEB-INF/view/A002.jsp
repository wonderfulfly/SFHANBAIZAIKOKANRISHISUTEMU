...
function DoMustCheck(){
	...
	if (getObj("Grid13flg" + i)) if (getObj("Grid13flg" + i).value != '0') {
		if( !checkRequired(getObj('SHAINMEI1_' + i),"社員名",true,"第"+i+"行項目「@@」が空白になっています。")) return false;	}
	}
...
if (getObj("Grid13flg" + i) &&  (getObj("Grid13flg" + i).value != '')) {
 		if(!isLenCheck(getObj('SHAINMEI1_' + i), 10, "社員名", true)) { alertMsg = '' + i +'行目の[社員名]項目に入力できるのは[最大長さは10の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('DENWABANGOU_' + i), 20, "電話番号", true)) { alertMsg = '' + i +'行目の[電話番号]項目に入力できるのは[最大長さは20の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('KEITAIBANGOU_' + i), 20, "携帯番号", true)) { alertMsg = '' + i +'行目の[携帯番号]項目に入力できるのは[最大長さは20の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('EMAIL_' + i), 50, "EMAIL", true)) { alertMsg = '' + i +'行目の[EMAIL]項目に入力できるのは[最大長さは50の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('LINE_' + i), 20, "LINE", true)) { alertMsg = '' + i +'行目の[LINE]項目に入力できるのは[最大長さは20の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('ROGUINID_' + i), 30, "ログインID", true)) { alertMsg = '' + i +'行目の[ログインID]項目に入力できるのは[最大長さは30の値]のみです。'; alert(alertMsg); return false; }}	}
...
function doLinkTrans9(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("A002A001i.do?","0","","","","_self","","0","714","416");
}
function doLinkTrans29(o){ SF.setServerExecute(true);

 pageLinkTranfer("A002A001u.do?","1",o,"SHAINID1,ROGUINID1,","SHAINID1_,ROGUINID_,","_self","","0","714","416");
}
...
Grid13 = $("#Grid13").aingrid({
 	...
 	isMobile:false,
 	initialLoad: false,
 	colWidths: [50,89,118,114,127,127,115,96,64,0],
 	rowClasses: ['ui-grid-row-style1', 'ui-grid-row-style2'],
 	addRowMethod: 2,
 	bodyHeight: 34,
 	hasFooter: true,
 	hasScroll: true,
 	colDataType: [0,2,2,2,2,2,2,2,2,2],
 	colDataId: ['lvl','SHAINID1_','SHAINMEI1_','DENWABANGOU_','KEITAIBANGOU_','EMAIL_','LINE_','YUUZAAKENGEN_','grdB6W6_','ROGUINID_'],
 	autoRowId: false,
  colsetting: false,
 	...
 	colClasses:['grid-col-num','g1','g1','g1','g1','g1','g1','g1','g1','g1'],
 	resizableCols: false,
 	url: 'A002GridFormFeed.do?pageID=P00002&subID=13',
 	extraParams: {},
 	paging: false,
...
<li><span>社員管理</span></li>
	<li class="current"><em>社員検索(P00002 - A002)</em></li>
</ul>
</div>
...
<form name="form1" id="form1">
  ...
  <input type=hidden name="PageID" id="PageID" value="P00002"/>
...
<div id="dragB1"  style="position:absolute;top:24px;left:74px;text-align:right;padding-right:2px;vertical-align:bottom;width:75px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='SHAINID'  style='display:table-cell;width:75px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;' _subid=1 class='' id="C2"><b>社員ID</b></label></div>
<div id="dragB3"  style="position:absolute;top:24px;left:151px;text-align:left;width:136px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='SHAINID'  name='SHAINID'  value='${requestScope.SHAINID}'  class='editable' style='width:136px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;'  _subid='3'  _itemname='社員ID'  type='text'  tabindex='2'></div>
<div id="dragB5"  style="position:absolute;top:24px;left:437px;text-align:right;padding-right:2px;vertical-align:bottom;width:69px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='SHAINMEI'  style='display:table-cell;width:69px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;' _subid=5 class='' id="M2"><b>社員名</b></label></div>
<div id="dragB7"  style="position:absolute;top:24px;left:508px;text-align:left;width:125px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='SHAINMEI'  name='SHAINMEI'  value='${requestScope.SHAINMEI}'  class='editable' style='width:125px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;'  _subid='7'  _itemname='社員名'  type='text'  tabindex='4'></div>
...
<td class='g1 o' _colid=1 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='SHAINID1_0'  name='SHAINID1_0'  value='[自動採番]'  _k='1'  class='readonly' readOnly style='width:84px;height:25px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='15'  _itemname='社員ID' onblur='changeSpecHtml(this);' type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=2 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='SHAINMEI1_0'  name='SHAINMEI1_0'  class='editable' style='width:115px;height:31px; padding:0 2px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='17'  _itemname='社員名'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=3 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='DENWABANGOU_0'  name='DENWABANGOU_0'  class='editable' style='width:111px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='19'  _itemname='電話番号'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=4 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='KEITAIBANGOU_0'  name='KEITAIBANGOU_0'  class='editable' style='width:124px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='21'  _itemname='携帯番号'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='EMAIL_0'  name='EMAIL_0'  class='editable' style='width:124px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='23'  _itemname='EMAIL'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=6 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='LINE_0'  name='LINE_0'  class='editable' style='width:112px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;'  _subid='25'  _itemname='LINE'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
...
<td class='g1 o' _colid=8><div style="overflow:hidden;"><input id='grdB6W6_0'  name='grdB6W6_0'  value='編集'   _subid='29'  _itemname='編集'  type='button'  _gid='Grid13'  _gflg='Grid13flg0'  onclick='doLinkTrans29($(this));'  _sf_class='button_red'></div></td>
<td style ='display:none' width='0px' _colid=9><input id='ROGUINID_0'  name='ROGUINID_0'  _k='1'  type='hidden' ></div></td></tr></tbody></table></div>
   </div>
...
getQAjaxRunJson("rstfld",false,1,"","A002Init.do",true,setSendData(document.form1),"");
