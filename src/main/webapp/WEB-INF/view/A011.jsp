...
//*** Func Name: A011HANBAIKINGAKUCount ***
function A011HANBAIKINGAKUCount(o){
  var row = getGridRowIndex(o,"rowseq");
...
//*** Func Name: A011JPYGOUKEICount ***
function A011JPYGOUKEICount(o){
  var row = getGridRowIndex(o,"rowseq");
...
//*** Func Name: A011RMBGOUKEICount ***
function A011RMBGOUKEICount(o){
  var row = getGridRowIndex(o,"rowseq");
/*Grid「B18」の項目「販売金額」の合計*/
var result = 0;
var HANBAIKINGAKU = 0;
...
//*** Func Name: A011USDGOUKEICount ***
function A011USDGOUKEICount(o){
  var row = getGridRowIndex(o,"rowseq");
/*Grid「B18」の項目「販売金額」の合計*/
var result = 0;
var HANBAIKINGAKU = 0;
...
function doLinkTrans21(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("A011A009i.do?","0","","KYAKUSAKI,TANTOUSHA,CHUUBUNSHONO1,CHUUMONHIDZUKE1,NYUUKINKINGAKU1,","KYAKUSAKIMEISHOU,TANTOUSHA,CHUUBUNSHONO1,CHUUMONHIDZUKE1,JPYGOUKEI,","_self","","0","1133","340");
}
function doLinkTrans35(){ SF.setServerExecute(true);

 pageLinkTranfer("A011A009u.do?","0","","RYOUSHUUSHONO,CHUUBUNSHONO1,","RESHIITONO,CHUUBUNSHONO1,","_self","","0","1133","340");
}
function doLinkTrans65(){ SF.setServerExecute(true);

 pageLinkTranfer("A011A010i.do?","0","","","","_self","","0","1150","486");
}
function doLinkTrans119(o){ SF.setServerExecute(true);

 pageLinkTranfer("A011A013u.do?","1",o,"BUHINCHUUBUNSHOMEISAINO,BUHINCHUUBUNSHONO,KOUJIKANRIBANGOU1,SHANAIKOUJIBANGOU,","CHUUBUNSHOMEISAINO_,CHUUBUNSHONO1,SHANAIKOUJIBANGOU1,SHANAIKOUJIBANGOU1,","_self","","0","1619","9804");
}
function doLinkTrans121(o){ SF.setServerExecute(true);

 pageLinkTranfer("A011A013i.do?","1",o,"BUHINCHUUBUNSHONO,BUHINCHUUBUNSHOMEISAINO,KOUJIKANRIBANGOU1,SHANAIKOUJIBANGOU,","CHUUBUNSHONO1,CHUUBUNSHOMEISAINO_,SHANAIKOUJIBANGOU1,SHANAIKOUJIBANGOU1,","_self","","0","1619","9804");
}
...
<td class='g3 o' _colid=3 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='SUURYOU_0'  name='SUURYOU_0'  class='editable' style='width:89px;height:31px; padding:0 2px;text-align:right;padding-right:2px;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='101'  _itemname='数量'  type='text'  onChange ='getObj("SUURYOU_0").value=this.value;A011HANBAIKINGAKUCount($(this));A011JPYGOUKEICount($(this));A011RMBGOUKEICount($(this));A011USDGOUKEICount($(this));cs($(this),"rowseq","Grid95flg","0");'  _gid='Grid95'  _gflg='Grid95flg0' ></div></td>
...
<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style="overflow:hidden;"><select id=KAHEI_0 name=KAHEI_0 data-bind='value: KAHEI' _req=0 class='editable' _subid=105 _itemname='貨幣' _gid='Grid95' _gflg='Grid95flg0' onChange ='getObj("KAHEI_0").value=this.value;A011JPYGOUKEICount($(this));A011RMBGOUKEICount($(this));A011USDGOUKEICount($(this));cs($(this),"rowseq","Grid95flg","0");'  style='width:54px;height:27px;font-size:14px;color:#000000;font-weight:normal;'>
