...
//*** Func Name: F20220915201226810 ***
function F20220915201226810(o){
  var row = getGridRowIndex(o,"rowseq");
...
//*** Func Name: F20220915201226827 ***
function F20220915201226827(o){
  var row = getGridRowIndex(o,"rowseq");
...
//*** Func Name: F20220915201226844 ***
function F20220915201226844(o){
  var row = getGridRowIndex(o,"rowseq");
/*Grid「B18」の項目「販売金額」の合計*/
var result = 0;
var HANBAIKINGAKU = 0;
...
//*** Func Name: F20220915201226862 ***
function F20220915201226862(o){
  var row = getGridRowIndex(o,"rowseq");
/*Grid「B18」の項目「販売金額」の合計*/
var result = 0;
var HANBAIKINGAKU = 0;
...
function doLinkTrans21(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("L00044.do?","0","","KYAKUSAKI,TANTOUSHA,CHUUBUNSHONO1,CHUUMONHIDZUKE1,NYUUKINKINGAKU1,","KYAKUSAKIMEISHOU,TANTOUSHA,CHUUBUNSHONO1,CHUUMONHIDZUKE1,JPYGOUKEI,","_self","","0","1133","340");
}
function doLinkTrans35(){ SF.setServerExecute(true);

 pageLinkTranfer("L00045.do?","0","","RYOUSHUUSHONO,CHUUBUNSHONO1,","RESHIITONO,CHUUBUNSHONO1,","_self","","0","1133","340");
}
function doLinkTrans65(){ SF.setServerExecute(true);

 pageLinkTranfer("L00048.do?","0","","","","_self","","0","1150","486");
}
function doLinkTrans119(o){ SF.setServerExecute(true);

 pageLinkTranfer("L00046.do?","1",o,"BUHINCHUUBUNSHOMEISAINO,BUHINCHUUBUNSHONO,KOUJIKANRIBANGOU1,SHANAIKOUJIBANGOU,","CHUUBUNSHOMEISAINO_,CHUUBUNSHONO1,SHANAIKOUJIBANGOU1,SHANAIKOUJIBANGOU1,","_self","","0","1619","9804");
}
function doLinkTrans121(o){ SF.setServerExecute(true);

 pageLinkTranfer("L00047.do?","1",o,"BUHINCHUUBUNSHONO,BUHINCHUUBUNSHOMEISAINO,KOUJIKANRIBANGOU1,SHANAIKOUJIBANGOU,","CHUUBUNSHONO1,CHUUBUNSHOMEISAINO_,SHANAIKOUJIBANGOU1,SHANAIKOUJIBANGOU1,","_self","","0","1619","9804");
}
...
<td class='g1 o' _colid=5 style ='vertical-align:middle;'><div style="overflow:hidden;"><select id=KAHEI_0 name=KAHEI_0 data-bind='value: KAHEI' _req=0 class='editable' _subid=105 _itemname='貨幣' _gid='Grid95' _gflg='Grid95flg0' onChange ='getObj("KAHEI_0").value=this.value;F20220915201226827($(this));F20220915201226844($(this));F20220915201226862($(this));cs($(this),"rowseq","Grid95flg","0");'  style='width:54px;height:27px;font-size:14px;color:#000000;font-weight:normal;'>
