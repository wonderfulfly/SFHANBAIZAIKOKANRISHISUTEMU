...
function DoMustCheck(){
	...
	if (getObj("Grid13flg" + i)) if (getObj("Grid13flg" + i).value != '0') {
		if( !checkRequired(getObj('BUMONMEI1_' + i),"部門名",true,"第"+i+"行項目「@@」が空白になっています。")) return false;	}
	}
...
if (getObj("Grid13flg" + i) &&  (getObj("Grid13flg" + i).value != '')) {
 		if(!isLenCheck(getObj('BUMONID1_' + i), 10, "部門ID", true)) { alertMsg = '' + i +'行目の[部門ID]項目に入力できるのは[最大長さは10の値]のみです。'; alert(alertMsg); return false; } 		if(!isLenCheck(getObj('BUMONMEI1_' + i), 50, "部門名", true)) { alertMsg = '' + i +'行目の[部門名]項目に入力できるのは[最大長さは50の値]のみです。'; alert(alertMsg); return false; }}	}
...
function doLinkTrans9(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("A014A003i.do?","0","","","","_self","","0","610","264");
}
function doLinkTrans19(o){ SF.setServerExecute(true);

 pageLinkTranfer("A014A003u.do?","1",o,"BUMONID1,","BUMONID1_,","_self","","0","610","264");
}
...
Grid13 = $("#Grid13").aingrid({
 	...
 	hasScroll: true,
 	colDataType: [0,2,2,2],
 	colDataId: ['lvl','BUMONID1_','BUMONMEI1_','grdC6R6_'],
 	autoRowId: false,
  colsetting: false,
 	...
 	colClasses:['grid-col-num','g1','g1','g1'],
 	resizableCols: false,
 	url: 'A014GridFormFeed.do?pageID=P00004&subID=13',
 	extraParams: {},
 	paging: false,
...
<li><span>社員管理</span></li>
	<li class="current"><em>部門検索(P00004 - A014)</em></li>
</ul>
</div>
...
<div id="dragB1"  style="position:absolute;top:24px;left:74px;text-align:right;padding-right:2px;vertical-align:bottom;width:75px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='BUMONID'  style='display:table-cell;width:75px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;' _subid=1 class='' id="C2"><b>部門ID</b></label></div>
<div id="dragB3"  style="position:absolute;top:24px;left:151px;text-align:left;width:136px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='BUMONID'  name='BUMONID'  value='${requestScope.BUMONID}'  class='editable' style='width:136px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;'  _subid='3'  _itemname='部門ID'  type='text'  tabindex='2'></div>
<div id="dragB5"  style="position:absolute;top:24px;left:437px;text-align:right;padding-right:2px;vertical-align:bottom;width:69px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='BUMONMEI'  style='display:table-cell;width:69px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;' _subid=5 class='' id="M2"><b>部門名</b></label></div>
<div id="dragB7"  style="position:absolute;top:24px;left:508px;text-align:left;width:125px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='BUMONMEI'  name='BUMONMEI'  value='${requestScope.BUMONMEI}'  class='editable' style='width:125px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;'  _subid='7'  _itemname='部門名'  type='text'  tabindex='4'></div>
...
<div id="dragB11"  style="position:absolute;top:82px;left:508px;text-align:left;width:125px;height:32px;z-index:1;" class='userDiv' _ckf='0'><input id='O4'  name='O4'  value='検索'  style='width:125px;height:32px;padding:0 2px;text-align:center;vertical-align:middle;font-size:14px;font-weight:normal;' type='button'  onClick ='if (SF.isServerExecute()) {SF.setServerExecute(false); doSmartSearch("O4","13;grdC6","1");}'  tabindex='6' class='button_blue' _sf_class='button_blue'></div>
<div id="dragB13"  style="position:absolute;top:138px;left:93px;text-align:left;height:141px;z-index:1;" class='userDiv' _ckf='0'><input type='hidden' name='initRowGrid13' id='initRowGrid13' value='0'><input type='hidden' name='RowGrid13' id='RowGrid13' value='0'><table id='Grid13' name ='Grid13' ><thead><tr><th style='text-align:center;'>No.</th><th style='overflow:hidden;text-align:center;'>部門ID</th><th style='overflow:hidden;text-align:center;'>部門名</th><th style='overflow:hidden;text-align:center;'>編集</th></tr></thead>
<tbody>
...
<td class='g1 o' _colid=1 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='BUMONID1_0'  name='BUMONID1_0'  _k='1'  class='editable' style='width:285px;height:31px; padding:0 2px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='15'  _itemname='部門ID'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=2 style ='vertical-align:middle;'><div style="overflow:hidden;"><input id='BUMONMEI1_0'  name='BUMONMEI1_0'  class='editable' style='width:250px;height:31px; padding:0 2px;text-align:left;font-size:14px;color:#000000;font-weight:normal;'  _subid='17'  _itemname='部門名'  type='text'  _gid='Grid13'  _gflg='Grid13flg0' ></div></td>
<td class='g1 o' _colid=3><div style="overflow:hidden;"><input id='grdC6R6_0'  name='grdC6R6_0'  value='編集'   _subid='19'  _itemname='編集'  type='button'  _gid='Grid13'  _gflg='Grid13flg0'  onclick='doLinkTrans19($(this));'  _sf_class='button_red'></div></td></tr></tbody></table></div>
   </div>
...
getQAjaxRunJson("rstfld",false,1,"","A014Init.do",true,setSendData(document.form1),"");
