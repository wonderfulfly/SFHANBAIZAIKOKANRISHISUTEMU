...
//*** Func Name: F20220915174752763 ***
function F20220915174752763(o){
  var row = getGridRowIndex(o,"rowseq");
...
//*** Func Name: F20220915174752781 ***
function F20220915174752781(o){
  var row = getGridRowIndex(o,"rowseq");
...
function S120220915174752763(){var intRow = getObj("RowGrid61").value;
...
function S120220915174752781(){var intRow = getObj("RowGrid61").value;
for (var row = 1;row <= intRow; row++) {
/*Grid項目「B8」の項目「振出済み金額」/界面項目「入金金額」*数字「100」*/
var result = 0;
...
function doLinkTrans57(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("L00007.do?","0","","","","_self","","0","1467","368");
}
function doLinkTrans59(){ SF.setServerExecute(true);

 pageLinkTranfer("L00013.do?","0","","CHUUBUNSHONO1,","CHUUBUNSHONO1,","_self","","0","1157","3455");
}
...
<div id="dragB35"  style="position:absolute;top:82px;left:679px;text-align:left;width:151px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='NYUUKINKINGAKU1'  name='NYUUKINKINGAKU1'  value='${requestScope.NYUKIN.getNYUUKINKINGAKU()}' data-bind='value: NYUUKINKINGAKU1' class='editable' style='width:151px;height:34px;padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='35'  _itemname='入金金額'  _ire='###,###,##0'  _rge='1'  type='text'  onChange ='if (SF.isServerExecute()) {getObj("NYUUKINKINGAKU1").value=this.value;S120220915174752763();S120220915174752781();}'  tabindex='18'></div>
