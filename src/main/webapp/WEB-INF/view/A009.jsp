...
//*** Func Name: A009FURIDASHIZUMIWARIAICount ***
function A009FURIDASHIZUMIWARIAICount(o){
  var row = getGridRowIndex(o,"rowseq");
...
function A009NYUUKINKINGAKU1S1(){var intRow = getObj("RowGrid61").value;
...
//*** Func Name: A009NYUUKINZUMIWARIAICount ***
function A009NYUUKINZUMIWARIAICount(o){
  var row = getGridRowIndex(o,"rowseq");
...
function doLinkTrans57(){ SF.setServerExecute(true);
 ...
 pageLinkTranfer("A009A008i.do?","0","","","","_self","","0","1467","368");
}
function doLinkTrans59(){ SF.setServerExecute(true);

 pageLinkTranfer("A009A011u.do?","0","","CHUUBUNSHONO1,","CHUUBUNSHONO1,","_self","","0","1157","3455");
}
...
Grid61 = $("#Grid61").aingrid({
  ...
  colsetting: false,
 	...
 	resizableCols: false,
 	url: 'A009GridFormFeed.do?pageID=P00011&subID=61',
 	extraParams: {},
 	paging: false,
...
<li><span>入金管理</span></li>
	<li class="current"><em>入金管理詳細(P00011 - A009)</em></li>
</ul>
</div>
...
<div id="dragB35"  style="position:absolute;top:82px;left:679px;text-align:left;width:151px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='NYUUKINKINGAKU1'  name='NYUUKINKINGAKU1'  value='${requestScope.NYUKIN.getNYUUKINKINGAKU()}' data-bind='value: NYUUKINKINGAKU1' class='editable' style='width:151px;height:34px;padding:0 2px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;color:#000000;font-weight:normal;ime-mode:disabled;'  _subid='35'  _itemname='入金金額'  _ire='###,###,##0'  _rge='1'  type='text'  onChange ='if (SF.isServerExecute()) {getObj("NYUUKINKINGAKU1").value=this.value;A009NYUUKINKINGAKU1S1();A009NYUUKINKINGAKU1S1();}'  tabindex='18'></div>
