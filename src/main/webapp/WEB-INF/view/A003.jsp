...
function DoMustCheck(){
    if( !checkRequired(document.getElementById('BUMONID1'),'部門ID',true,'項目「@@」が空白になっています。', true)) {SF.setCheckSuccess(false);}
if( !checkRequired(document.getElementById('BUMONMEI1'),'部門名',true,'項目「@@」が空白になっています。', true)) {SF.setCheckSuccess(false);}
...
function DoDataCheck() {
    var alertMsg = "";
     if(getObj("BUMONID1")) {
	 if(!isLenMaxCheck(getObj("BUMONID1"),10,"部門ID",true)) { alertMsg = '[部門ID]項目に入力できるのは[最大長さは10の値]のみです。'; return false; }
	 }
	 if(!isLenCheck(getObj("BUMONID1"),10,"部門ID",true,true)) { alertMsg = '[部門ID]項目に入力できるのは[最大長さは10の値]のみです。';SF.setCheckSuccess(false); } if(getObj("BUMONMEI1")) {
	 if(!isLenMaxCheck(getObj("BUMONMEI1"),50,"部門名",true)) { alertMsg = '[部門名]項目に入力できるのは[最大長さは50の値]のみです。'; return false; }
	 }
	 if(!isLenCheck(getObj("BUMONMEI1"),50,"部門名",true,true)) { alertMsg = '[部門名]項目に入力できるのは[最大長さは50の値]のみです。';SF.setCheckSuccess(false); }
...
<li><span>社員管理</span></li>
	<li class="current"><em>部門(P00003 - A003)</em></li>
</ul>
</div>
...
<form name="form1" id="form1">
  ...
  <input type=hidden name="PageID" id="PageID" value="P00003"/>
...
<div id="dragB1"  style="position:absolute;top:111px;left:89px;text-align:right;padding-right:2px;vertical-align:bottom;width:75px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='BUMONID1'  style='display:table-cell;width:75px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;font-weight:normal;' _subid=1 class='' id="C5"><b>部門ID</b>:<i class='fa fa-exclamation-circle fontco01' aria-hidden='true' title='必須'></i></label></div>
<div id="dragB5"  style="position:absolute;top:111px;left:305px;text-align:right;padding-right:2px;vertical-align:bottom;width:70px;height:32px;z-index:1;" class='userDiv' _ckf='0'><label for='BUMONMEI1'  style='display:table-cell;width:70px;height:32px;line-height:32px;text-align:right;padding-right:2px;vertical-align:middle;font-size:14px;font-weight:normal;' _subid=5 class='' id="J5"><b>部門名</b>:<i class='fa fa-exclamation-circle fontco01' aria-hidden='true' title='必須'></i></label></div>
<div id="dragB9"  style="position:absolute;top:202px;left:201px;text-align:left;width:103px;height:32px;z-index:1;" class='userDiv' _ckf='0'><input id='G9'  name='G9'  value='保存'  style='width:103px;height:32px;padding:0 2px;padding:0 2px;text-align:center;vertical-align:middle;font-size:14px;font-weight:normal;' type='button'  onClick ='if (SF.isServerExecute()) {SF.setServerExecute(false);getObj("G9").value=this.value;F20091208153604208();}'  tabindex='5' class='button_blue' _sf_class='button_blue'></div>
<div id="dragB11"  style="position:absolute;top:202px;left:341px;text-align:left;width:102px;height:32px;z-index:1;" class='userDiv' _ckf='0'><input id='K9'  name='K9'  value='キャンセル'  style='width:102px;height:32px;padding:0 2px;padding:0 2px;text-align:center;vertical-align:middle;font-size:14px;font-weight:normal;' type='button'  onClick ='if (SF.isServerExecute()) {SF.setServerExecute(false);getObj("K9").value=this.value;F20091210135248447();}'  tabindex='6' class='button_red' _sf_class='button_red'></div>
<div id="dragB3"  style="position:absolute;top:111px;left:166px;text-align:left;width:103px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='BUMONID1'  name='BUMONID1'  value='${requestScope.BUMON.getBUMONID()}' data-bind='value: BUMONID1' _k='1'  class='editable' style='width:103px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;font-weight:normal;'  _subid='3'  _itemname='部門ID'  type='text'  tabindex='2'></div>
<div id="dragB7"  style="position:absolute;top:111px;left:377px;text-align:left;width:172px;height:34px;z-index:1;" class='userDiv' _ckf='0'><input id='BUMONMEI1'  name='BUMONMEI1'  value='${requestScope.BUMON.getBUMONMEI()}' data-bind='value: BUMONMEI1' class='editable' style='width:172px;height:34px;padding:0 2px;text-align:left;vertical-align:middle;font-size:14px;font-weight:normal;'  _subid='7'  _itemname='部門名'  type='text'  tabindex='4'></div>
   </div>
...
getQAjaxRunJson("rstfld",false,1,"","A003Init.do",true,setSendData(document.form1),"");
