 ...
 */public class A010grdC10AD101ClickdeleteBUHINDaoTest extends BaseTest {
    ...
    @Test
    @Rollback
	public void A010grdC10AD101ClickdeleteBUHIN () throws Exception {
		String CHUUBUNSHONO = "1";


		int returnVal = A010grdC10AD101ClickdeleteBUHINDao.A010grdC10AD101ClickdeleteBUHIN(CHUUBUNSHONO);
