 ...
 */public class A008TANTOUSHAIDSYAINDaoTest extends BaseTest {
    ...
    @Test
    @Rollback
	public void A008TANTOUSHAIDdrp () throws Exception {


		List<A008TANTOUSHAIDSYAINEntity> returnVal = A008TANTOUSHAIDSYAINDao.A008TANTOUSHAIDdrp();
